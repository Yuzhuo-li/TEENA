...
def fix_winbed_content(file_name, query_prefix, out_put_dir):
    file = open(file_name, 'r')
    result_fixed = open(f"{out_put_dir}{query_prefix}_homer.bed", 'w')
    ...
    result_fixed.close()
    file.close()
    return f"{out_put_dir}{query_prefix}_homer.bed"
